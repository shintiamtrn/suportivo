            ...
            <li>
              ...
              <div style="opacity: 0.9; z-index: 1000;" class="cbp-hrsub">
                <div class="cbp-hrsub-inner"> 
                  <div>
                     <a href="produk/monita"><h4>Monita</h4></a>
                    <ul>
                      <li><a href="produk/monita1">Monita AMR (Automatic Meter Reading) </a></li>
                      <li><a href="produk/monita2">Monita Engine Protection</a></li>
                      <li><a href="produk/monita2">Monita Marine (Vessel Monitoring System)</a></li>
                      <li><a href="produk/monita2">Monita Tanker Monitoring System </a></li>
                      <li><a href="produk/monita2">Monita Pembangkit (Power Generator) </a></li>
                      <li><a href="produk/monita2">Monita Penyulang (Feeder)</a></li>
                    </ul>
                   </div>
                  <div>
                    <a href="produk/haliza"><h4>Haliza</h4></a>
                    <ul>
                      <li><a href="produk/haliza1">Haliza Reciprocating</a></li>
                    </ul>
                  </div>
            </li>
          </ul>
